...
public class Generator {
	public static void main(String[] args) {
		String packageName = "com.neo";
		boolean serviceNameStartWithI = false;//auth -> UserService, 设置成true: auth -> IUserService
		generateByTables(serviceNameStartWithI, packageName, "zhuyf", "test", "user");
...
//				.setSuperMapperClass("cn.saytime.mapper.BaseMapper")
		...
		config.setActiveRecord(false)
				.setAuthor(author)
				.setOutputDir("F:\\spring-boot-examples\\spring-boot-docker/src/main/java")
